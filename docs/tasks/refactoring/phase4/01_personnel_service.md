...
## 작업 목록
- [ ] `apps/hr/personnel-service/src/main.ts` 수정
    - [ ] `bootstrapService` 사용으로 교체
- [ ] `apps/hr/personnel-service/src/app/app.module.ts` 수정
    - [ ] `SharedInfraModule` import
    - [ ] `SharedDomainModule` import
- [ ] 빌드 및 테스트
    - [ ] `nx build personnel-service`
    - [ ] `nx test personnel-service`
    - [ ] `nx e2e personnel-service-e2e`
