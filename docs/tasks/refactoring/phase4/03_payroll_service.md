...
## 작업 목록
- [ ] `apps/hr/payroll-service/src/main.ts` 수정
    - [ ] `bootstrapService` 사용으로 교체
- [ ] `apps/hr/payroll-service/src/app/app.module.ts` 수정
    - [ ] `SharedInfraModule` import
    - [ ] `SharedDomainModule` import
- [ ] 빌드 및 테스트
    - [ ] `nx build payroll-service`
    - [ ] `nx test payroll-service`
    - [ ] `nx e2e payroll-service-e2e`
