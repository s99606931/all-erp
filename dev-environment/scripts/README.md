...
스크립트는 **Docker 환경**과 **로컬 환경**을 모두 지원하지만, **Docker 환경 사용을 권장**합니다.
...
Docker를 사용할 수 없는 경우 로컬에서 실행됩니다. 이 경우 다음이 필요합니다:

- Node.js & pnpm 설치
- 의존성 패키지 설치 (`pnpm install`)
